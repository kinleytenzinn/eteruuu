<?php
    ...
    if ($userId ==5903 || 12024) {//bumthang
        ...
        ON a.ORIG_USER_ID=b.USER_ID WHERE a. ORIG_ENTITY_TYPE='2' AND a.ORIG_PROFILE_ID='25' AND a.ORIG_USER_ID IN(4467,4471,4473,4478) AND
