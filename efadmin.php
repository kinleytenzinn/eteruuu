<?php
    ...
    //column names
    $fields = array('TRANSACTION_ID','TRANSACTION_DATE','SERVICE_NAME','TRANSACTION_AMOUNT','ORIG_USER_ID','ORIG_MSISDN','ORIG_FULL_NAME','DEST_MSISDN','DEST_FULL_NAME','DZONGKHAG_NAME');
    ...
    if ($userId==1638 || 12024){
        $sql="SELECT a.TRANSACTION_ID,a.TRANSACTION_DATE, a.SERVICE_NAME,a.TRANSACTION_AMOUNT,a.ORIG_USER_ID,a.ORIG_MSISDN, a.ORIG_FULL_NAME, a.DEST_MSISDN, a.DEST_FULL_NAME,
        DZONGKHAG_NAME FROM MFS_CDR_MASTER a
        LEFT JOIN MFS_USER_VIEW b
        ON a.DEST_USER_ID=b.USER_ID WHERE 
        a.DEST_USER_ID IN (1697,1687,1688,1693,1689,1694,1690,1695,1691,1696,1692) AND
        SERVICE_NAME='STOCK_TRANSFER'  AND STATUS_TYPE = 'S'";
        //AND TRANSACTION_DATE BETWEEN '2020-01-01 00:00:00' AND '2021-02-15 23:59:59';" ;
