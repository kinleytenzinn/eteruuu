<?php
    ...
    if ($userId ==5778 || 12024) {//pling
        ...
        ON a.ORIG_USER_ID=b.USER_ID WHERE a. ORIG_ENTITY_TYPE='2' AND a.ORIG_PROFILE_ID='25' AND a.ORIG_USER_ID IN(4537,4511,4515,4518,4521,4525,4527,4529,4532,343650) AND
