<?php
    ...
    if ($userId ==5877 || 12024) {//gelephu
        ...
        ON a.ORIG_USER_ID=b.USER_ID WHERE a. ORIG_ENTITY_TYPE='2' AND a.ORIG_PROFILE_ID='25' AND a.ORIG_USER_ID IN(4479,4480,4481,4482,4483) AND
