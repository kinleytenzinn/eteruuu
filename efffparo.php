<?php
    ...
    if ($userId ==5758 || 12024) {//paro
        ...
        ON a.ORIG_USER_ID=b.USER_ID WHERE a. ORIG_ENTITY_TYPE='2' AND a.ORIG_PROFILE_ID='25' AND a.ORIG_USER_ID IN(4498,4499,4501,4503,4504) AND
