<?php
    ...
    if ($userId ==5788 || 12024) {//wangdue
        ...
        ON a.ORIG_USER_ID=b.USER_ID WHERE a. ORIG_ENTITY_TYPE='2' AND a.ORIG_PROFILE_ID='25' AND a.ORIG_USER_ID IN(4566,4562,4559,4549,4547) AND
