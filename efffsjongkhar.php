<?php
    ...
    if($userId ==5907 || 12024) {//sjk
        ...
        ON a.ORIG_USER_ID=b.USER_ID WHERE a. ORIG_ENTITY_TYPE='2' AND a.ORIG_PROFILE_ID='25' AND a.ORIG_USER_ID IN(4557,4560,4561,4563,4570) AND
