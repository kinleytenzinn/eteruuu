<?php
    ...
    if ($userId ==5910 || 12024) {//tgang
        ...
        ON a.ORIG_USER_ID=b.USER_ID WHERE a. ORIG_ENTITY_TYPE='2' AND a.ORIG_PROFILE_ID='25' AND a.ORIG_USER_ID IN(4689,4707,4708,4710,4639,4636,4634) AND
