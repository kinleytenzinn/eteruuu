<?php
    ...
    if ($userId == 5914 || 12024) {//Mongar
        ...
        ON a.ORIG_USER_ID=b.USER_ID WHERE a. ORIG_ENTITY_TYPE='2' AND a.ORIG_PROFILE_ID='25' AND a.ORIG_USER_ID IN(4484,4489,4491,4493,4495,4497) AND
