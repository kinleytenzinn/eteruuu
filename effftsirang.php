<?php
    ...
    if($userId ==5919 || 12024) {//tsriang
        ...
        ON a.ORIG_USER_ID=b.USER_ID WHERE a. ORIG_ENTITY_TYPE='2' AND a.ORIG_PROFILE_ID='25' AND a.ORIG_USER_ID IN(4633,4629,4606,4597) AND
