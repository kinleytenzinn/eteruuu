<?php
    ...
    if ($userId ==  5877 || 1638) { //gelephu MASTER AGENT TO ACCOUNTANT/ CUSTOMER FOR TOPUP
        $sql="SELECT a.TRANSACTION_ID,a.TRANSACTION_DATE, a.SERVICE_NAME,a.TRANSACTION_AMOUNT,a.ORIG_USER_ID,a.ORIG_MSISDN,a.ORIG_PROFILE_ID, a.ORIG_FULL_NAME, a.DEST_MSISDN, a.DEST_FULL_NAME,a.DEST_BAL_BEFORE,a.DEST_BAL_AFTER,b.PARENT_NAME
        FROM MFS_CDR_MASTER a
        LEFT JOIN MFS_USER_VIEW b
        ON a.DEST_USER_ID=b.USER_ID WHERE 
        a. DEST_USER_ID IN (5754,5941,5948,6871,5953) AND 
