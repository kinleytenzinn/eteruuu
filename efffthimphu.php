<?php
    ...
    //column names
    $fields = array('TRANSACTION_ID','TRANSACTION_DATE','SERVICE_NAME','TRANSACTION_AMOUNT','ORIG_USER_ID','ORIG_MSISDN','ORIG_FULL_NAME','DEST_MSISDN','DEST_FULL_NAME','ORIG_BAL_BEFORE','ORIG_BAL_AFTER','PARENT_NAME');
    ...
    if ($userId ==5053 || 5063 || 12024) {//thimphu
        $sql="SELECT a.TRANSACTION_ID,a.TRANSACTION_DATE,a.SERVICE_NAME,a.TRANSACTION_AMOUNT,a.ORIG_MSISDN, a.`ORIG_FULL_NAME`, a.ORIG_USER_ID, 
        a.ORIG_BAL_BEFORE,
        a.ORIG_BAL_AFTER, a.DEST_MSISDN, a.DEST_FULL_NAME,
        b. PARENT_NAME FROM MFS_CDR_MASTER a
        LEFT JOIN MFS_USER_VIEW b
        ON a.ORIG_USER_ID=b.USER_ID WHERE a. ORIG_ENTITY_TYPE='2' AND a.ORIG_PROFILE_ID='25' AND a.ORIG_USER_ID IN(4591,4593,4599,4604,4609,4623,4625,1671,4123,4677,4102,4681,4687,1656,4523) AND
        SERVICE_NAME IN ('CASH_IN', 'CASH_OUT', 'SELL_DEPOSIT', 'P2P_UN_REG_CONSUME', 'TOPUP','REV_TOPUP', 'REV_CASH_IN') AND STATUS_TYPE = 'S'";
        //AND a.TRANSACTION_DATE BETWEEN '2020-04-01 00:00:00' AND '2021-08-30 23:59:59' ";
