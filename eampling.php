<?php
    ...
    if ($userId == 5778|| 1638) { //pling MASTER AGENT TO ACCOUNTANT/ CUSTOMER FOR TOPUP
        ...
        a. DEST_USER_ID IN (6817,5930,5928,6168,5921,6819,6819,6176,5915) AND 
...
if ($userId ==  5778 || 1638) { //pling MASTER AGENT TO ACCOUNTANT/ CUSTOMER FOR TOPUP
    ...
    LEFT JOIN MFS_USER_VIEW b
    ON a.DEST_USER_ID=b.USER_ID WHERE 
    a. DEST_USER_ID IN (6817,5930,5928,6168,5921,6819,6821,6176,5915,357321) AND 
    SERVICE_ID = '7' AND STATUS_TYPE = 'S'";
}
